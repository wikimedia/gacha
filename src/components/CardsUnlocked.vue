...
const getCategoryClass = (category: string) => {
  switch (category) {
    case 'Sports':
      return 'bg-category-sports-icon-bg text-category-sports-text border-category-sports-border/40 dark:bg-category-sports-icon-bg-dark dark:text-category-sports-text-dark dark:border-category-sports-border/20';
    case 'People / Culture':
